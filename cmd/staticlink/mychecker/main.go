// Package main реализует multichecker для проверки кода нужными анализаторами
// В функции main указаны подключаемые анализаторы
...
func main() {
	...
	mychecks = append(mychecks, exitchecker.ExitCheckAnalyzer) // проверяет использование прямого вызова os.Exit в функции main пакета main
